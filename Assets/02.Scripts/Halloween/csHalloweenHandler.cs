...
public class csHalloweenHandler : MonoBehaviour
{
    ...
    private void Check()
    {
        ...
        GameObject obj = csPooledCandy.instance.GetPooledObject_Candy(gameObject.transform);
        obj.SetActive(true);

        int way = gameObject.GetComponent<csMoveMonster>().randomWay;
        gameObject.transform.position = csPooledMonster.instance.spawnMonsterPoint[way].position;

        csPooledMonster.instance.poolObjs_Monster.Remove(gameObject);
        csPooledMonster.instance.poolObjs_Monster.Add(gameObject);
