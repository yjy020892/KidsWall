...
public class csDinosaurHandler : MonoBehaviour
{
    ...
    private void Check()
    {
        ...
        if (this.gameObject.GetComponent<csDinosaur>().wayNum == 1)
        {
        ...
        if (transform.name.Equals("T_REX"))
        {
        ...
        GameObject obj = csPooledDinosaurEffect.instance.GetPooledObject_DinosaurEffect(transform);
        obj.SetActive(true);
