...
public class csZombieHandler : MonoBehaviour
{
    ...
    private void Check()
    {
        ...
        else if (gameObject.name.Equals("Crow"))
        {
            csSoundManager.instance.PlayBirdHitSound();
        }

        GameObject obj = csPooledZombieEffect.instance.GetPooledObject_ZombieEffect(gameObject.transform);
        obj.SetActive(true);

        csPooledZombie.instance.poolObjs_Zombie.Remove(gameObject.transform.gameObject);
        csPooledZombie.instance.poolObjs_Zombie.Add(gameObject.transform.gameObject);
