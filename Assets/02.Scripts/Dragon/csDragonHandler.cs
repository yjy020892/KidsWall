...
public class csDragonHandler : MonoBehaviour
{
    ...
    private void Check()
    {
        ...
        GameObject obj = csPooledDragonEffect.instance.GetPooledObject_DragonEffect(gameObject.transform);
        obj.SetActive(true);

        csPooledDragon.instance.poolObjs_Dragon.Remove(gameObject.transform.gameObject);
        csPooledDragon.instance.poolObjs_Dragon.Add(gameObject.transform.gameObject);
