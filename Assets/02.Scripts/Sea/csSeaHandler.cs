...
public class csSeaHandler : MonoBehaviour
{
    ...
    private void Check()
    {
        ...
        csSeaManager.instance.fishCnt -= 1;

        GameObject obj = csPooledBubble.instance.GetPooledObject_Bubble(transform);
        obj.SetActive(true);

        csPooledFish.instance.poolObjs_Fish.Remove(transform.gameObject);
        csPooledFish.instance.poolObjs_Fish.Add(transform.gameObject);
